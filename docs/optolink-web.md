...
Optolink-Web currently has no application-level authentication. Keep it on a trusted LAN or behind an authenticated reverse proxy, especially before enabling writes.
