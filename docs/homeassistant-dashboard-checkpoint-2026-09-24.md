...
Status: **maintenance backend and Home Assistant path fully live-verified end-to-end**
...
MQTT Discovery was subsequently verified live: both Number entities point only
